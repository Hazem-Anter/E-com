...
namespace Ecom.BLL.Service.Abstraction
{
    ...
    {
        // CREATE
        Task<ResponseResult<GetOrderVM>> CreateOrderAsync(CreateOrderVM model);
        ...
        // UPDATE STATUS
        Task<ResponseResult<bool>> UpdateStatusAsync(int id, OrderStatus newStatus, string updatedBy, string? trackingNumber);
